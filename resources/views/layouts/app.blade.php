...
<head>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1">
     <link rel="icon" type="img/ico" href="{{ URL::to('img/logo.png')}}">
    <!-- CSRF Token -->
    <meta name="csrf-token" content="{{ csrf_token() }}">

    <title>Tropical Turismo</title>
    ...
    <div class="container-fluid">
      <div class="navbar-header">
        <a class="navbar-brand" href="#">
          <span class="logo-mini"><font size="6"><p> <img src="{{ URL::to('img/logo.png')}}" style="width:5%;"> Tropical Turismo &nbsp;&nbsp;</p></font></span>
        </a>
      </div>

        ...
        <div id="home" class="tab-pane fade in active">
          <div role="tabpanel" class="tab-pane active" id="home">
            ...
            <div class="w3-row-padding">
                ...
                <form class="form-group"  action="{{route('reserva_inser')}}" method="post" novalidate>
                  ...
                  <div class="form-group">
                    ...
                    <input type="number" class="form-control" name="n_a"  placeholder="Escreva um numero de Adultos:">
                  </div>
                  <div class="form-group">
                    <label >Nº Crianças:</label>
                    <input type="number" class="form-control" name="n_b"  placeholder="Escreva um numero de Crianças:">
                  </div>
                  <div class="form-group">
                      <div class='form-group'>
                       <label>Excursões: </label><br>
                        <select  name="excursoes" class="form-control" required="required">
                              @foreach($excursoe as $excursoes)
                                <option value="{{$excursoes->id}}" >{{$excursoes->name}}-{{$excursoes->hora_saida}}|{{$excursoes->hora_regresso}}</option>
                              @endforeach
                        </select>
                    </div>
                  </div>

        ...
        <div id="home" class="tab-pane fade in active">
          <div role="tabpanel" class="tab-pane active" id="home">
            <div class="w3-row-padding">
                ...
                <form class="form-group"  action="{{route('transfer_inser')}}" method="post" novalidate>
                  <div class="form-group">
                    <label >Name:</label>
                    <input type="text" class="form-control" name="name" placeholder="Escreva o seu nome:">
                  </div>
                  <div class="form-group">
                    <label >Email:</label>
                    <input type="email" class="form-control" name="email" placeholder="Escreva o seu email:">
                  </div>
                  <div class="form-group">
                    <label >Nº Pessoas:</label>
                    <input type="number" class="form-control" name="n_pessoas"  placeholder="Escreva um numero de pessoas:">
                  </div>
                  <div class="form-group">
                      <div class='form-group'>
                       <label>Transfers: </label><br>
                        <select  name="transfer" class="form-control" required="required">
                              <option value="t_30" >30€ por Carro (1-4 Pessoas)</option>
                              <option value="t_50" >50€ por Carro (1-8 Pessoas)</option>
                        </select>
                    </div>
                  </div>
                  <div class="form-group">
                    <div class='form-group has-feedback'>
                      <label>Dia do Transfer : </label><br>
                  ...
                  <div class="form-group">
                     <div class='form-group has-feedback'>
                       <label>Hora: </label><br>
                       <p class="bg-warning">Entre as 22:OO e as 8:00  ira ser acrescentado 20% ao valor total do transfer</p>
                       <div class="input-group clockpicker">                          
                           <input type="text" class="form-control"  name='hora_t' >
                  ...
                  <div class="form-group">
                    ...
                    <input type="String"   class="form-control" name="loc" placeholder="Escreva um numero de pessoas:">
                  </div>
                  <input type="text" name="_token"  value="{{ csrf_token() }}" style="display: none" >
                  <button type="submit" class="btn btn-default">Requisitar Transfer</button>
                </form>
            </div>
          </div>
        </div>
